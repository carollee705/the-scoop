...
function createComment(url, request) {
  ...
  if (request.body && request.body.comment && request.body.comment.body && request.body.comment.username &&
      request.body.comment.articleId && database.users[request.body.comment.username]
...
function updateComment(url, request) {
  ...
  const requestComment = request.body && request.body.comment && request.body.comment.body;
  const response = {};
  ...
  if (!id || !requestComment) {
    ...
    savedComment.body = requestComment;
